...
INSERT INTO `post` (`id`, `content`, `title`, `post_date`, `enabled`, `user_id`) VALUES (2, 'I\'m a huge Tolkien fan, but I\'ve only ever watched the movies. I am going to start reading the books and am super excited', 'Admin is here to assist!', '2022-05-25 15:11:34', 1, 3);
...
INSERT INTO `book_to_category` (`book_id`, `category_id`) VALUES (173, 2);
